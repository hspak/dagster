...
from dagster.core.meta.dauphin_types import build_dagster_type_namespace_snapshot
...
def test_kitchen_sink_of_collection_types_metas():
    ...
    something_tuple = namespace.get_dagster_type_meta(Dict[str, SomethingType].key)
