...
class DauphinExecutionStepOutput(dauphin.ObjectType):
    ...
    def __init__(self, step_output, pipeline_snapshot):
    ...
    def resolve_type(self, _graphene_info):
        return to_dauphin_dagster_type(self._step_output.dagster_type, self._pipeline_snapshot)
...
class DauphinExecutionStepInput(dauphin.ObjectType):
    ...
    def __init__(self, execution_plan, step_input, pipeline_snapshot):
    ...
    def resolve_type(self, _graphene_info):
        return to_dauphin_dagster_type(self._step_input.dagster_type, self._pipeline_snapshot)
    ...
    def resolve_inputs(self, graphene_info):
        return [
            graphene_info.schema.type_named('ExecutionStepInput')(
                self._execution_plan, inp, self._execution_plan.pipeline_def.get_pipeline_snapshot()
            )
    ...
    def resolve_outputs(self, graphene_info):
        return [
            graphene_info.schema.type_named('ExecutionStepOutput')(
                out, self._execution_plan.pipeline_def.get_pipeline_snapshot()
            )
