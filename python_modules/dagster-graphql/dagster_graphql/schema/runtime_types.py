...
def to_dauphin_dagster_type(dagster_type, pipeline_snapshot):
    ...
    base_args = dict(
        ...
        inner_types=_resolve_inner_types(dagster_type, pipeline_snapshot),
    )
...
def _resolve_inner_types(dagster_type, pipeline_snapshot):
    return list(
        map(lambda dt: to_dauphin_dagster_type(dt, pipeline_snapshot), dagster_type.inner_types)
    )
